...
pval <- read.csv("E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/pval_all_final.csv", header = TRUE, row.names = 1)
...
pdf("E:/2025.8-2026.7/iScience_revision/Figures/Figure 4.pdf", width = 18, height = 10)
draw(ht3)
dev.off()