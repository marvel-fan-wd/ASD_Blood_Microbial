...
cor <- read.csv("E:/2025.8-2026.7/iScience_revision/Prevalence_phenotype_association_beta.csv", header = TRUE, row.names = 1)
pval <- read.csv("E:/2025.8-2026.7/iScience_revision/Prevalence_phenotype_association_qval.csv", header = TRUE, row.names = 1)
