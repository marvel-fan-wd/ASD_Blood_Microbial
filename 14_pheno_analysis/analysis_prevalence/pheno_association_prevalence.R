...
row.names(otu_raw) <- otu_raw$X
otu_raw <- otu_raw[,-1]
otu_raw[otu_raw > 0] <- 1
otu_raw$X <- row.names(otu_raw)
...
for (i in 1:ncol(species_data)) {
  for (j in 1:ncol(phenotype_data)) {
	df <- as.data.frame(cbind(pheno = phenotype_data[, j], microbe = species_data[, i], covariates_data))
...
fwrite(as.data.frame(cor_matrix), "E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/continuous_cor.csv", row.names = T) 
fwrite(as.data.frame(p_matrix), "E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/continuous_p.csv", row.names = T) 
fwrite(as.data.frame(q_matrix), "E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/continuous_q_fdr.csv", row.names = T) 
fwrite(as.data.frame(err_matrix), "E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/continuous_err.csv", row.names = T) 
...
fwrite(as.data.frame(cor_matrix), "E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/logic_cor.csv", row.names = T) 
fwrite(as.data.frame(p_matrix), "E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/logic_p.csv", row.names = T) 
fwrite(as.data.frame(q_matrix), "E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/logic_q_fdr.csv", row.names = T) 
fwrite(as.data.frame(err_matrix), "E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/logic_err.csv", row.names = T) 
...
fwrite(as.data.frame(cor_matrix), "E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/logicf_cor.csv", row.names = T) 
fwrite(as.data.frame(p_matrix), "E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/logicf_p.csv", row.names = T) 
fwrite(as.data.frame(q_matrix), "E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/logicf_q_fdr.csv", row.names = T)
fwrite(as.data.frame(updown_matrix), "E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/logicf_updown.csv", row.names = T)

# Result combination
continuous_cor=read.csv("E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/continuous_cor.csv", header=T)
continuous_p=read.csv("E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/continuous_p.csv", header=T)
continuous_q=read.csv("E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/continuous_q_fdr.csv",header=T)

logic_cor=read.csv("E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/logic_cor.csv", header=T)
logic_p=read.csv("E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/logic_p.csv", header=T)# 3 associations significant (p < 0.05 firth correction)
logic_q=read.csv("E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/logic_q_fdr.csv", header=T) # 0 associations significant

logicf_cor=read.csv("E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/logicf_cor.csv", header=T)
logicf_p=read.csv("E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/logicf_p.csv", header=T) # 3 associations significant
logicf_q=read.csv("E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/logicf_q_fdr.csv", header=T) # 0 associations significant
...
logic_cor_final[10, 7] <- logicf_cor[10, 7]
...
fwrite(as.data.frame(corval), "E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/cor_all_final.csv", row.names = F)
fwrite(as.data.frame(pval), "E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/pval_all_final.csv", row.names = F)
fwrite(as.data.frame(qval), "E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/qval_all_final.csv", row.names = F)

# Visualization
corval <- read.csv("E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/cor_all_final.csv", 
                header = TRUE, row.names = 1)
pval <- read.csv("E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/pval_all_final.csv", 
                 header = TRUE, row.names = 1)
...
pdf("E:/2025.8-2026.7/iScience_revision/14_pheno_analysis/analysis_prevalence/heatmap_output.pdf", width = 15, height = 6.6)
draw(ht)
dev.off()